...
SELECT C.CNAME, O.ONO, O.ODATE, I.DESCRIPTION, IO.ITEMNO FROM ITEMS_ORDERS IO, CUSTOMER C, ORDERS O, ITEMS I WHERE O.CNO = C.CNO AND IO.ITEMNO = I.ITEMNO AND CNAME = 'Mr.Patil' GROUP BY IO.ITEMNO;
